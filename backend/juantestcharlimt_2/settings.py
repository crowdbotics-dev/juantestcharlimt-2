"""
Django settings for juantestcharlimt_2 project.
...
ROOT_URLCONF = 'juantestcharlimt_2.urls'
...
WSGI_APPLICATION = 'juantestcharlimt_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "juantestcharlimt_2 API",
    "DESCRIPTION": "API documentation for juantestcharlimt_2 App",
    "VERSION": "v1",
}
